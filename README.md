...
docker run -p 127.0.0.1:8317:8317 \
  ...
  ghcr.io/greensheep999/cursor-proxy:cursor3.11-v0.3.3
```
...
```
ghcr.io/greensheep999/cursor-proxy:cursor3.11-v0.3.3<X.Y>-v<x.y.z>
```
...
Latest 3.10 image: `ghcr.io/greensheep999/cursor-proxy:cursor3.11-v0.3.3`.
